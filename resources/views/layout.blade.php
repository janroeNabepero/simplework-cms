...
<body>
    ...
    <div id="header" class="container">
        <div id="logo">
            <h1><a href="{{url('/')}}">SimpleWork</a></h1>
        </div>
        <div id="menu">
            <ul>
                <li class="{{ Request::path() === '/' ? 'current_page_item' : ''}}"><a href="{{url('/')}}" accesskey="1" title="">Homepage</a></li>
                <li class="{{ Request::path() === 'clients' ? 'current_page_item' : ''}}"><a href="{{url('/clients')}}" accesskey="2" title="">Our Clients</a></li>
...
<div id="copyright" class="container">
    <p>&copy; Trash. No rights reserved. | Photos by <a href="http://fotogrph.com/">Fotogrph</a> | Design by <a href="http://templated.co" rel="nofollow">TEMPLATED</a>.</p>
</div>
</body>
</html>